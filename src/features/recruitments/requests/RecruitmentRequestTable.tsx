...
import EnhancedTableHead, { Data } from "./EnhancedTableHead";
import { Order, getComparator, stableSort } from "@/utils/functions/mui";
...
export default function RecruitmentRequestTable() {
